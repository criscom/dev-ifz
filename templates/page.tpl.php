      ...
      <div class="header__name-and-slogan">
        <?php if ($site_name): ?>
          <h1 class="header__site-name">
            <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" class="header__site-link" rel="home"><span class="acronym">IFZ -</span><span class="fullname"><?php print $site_name; ?></span></a>
          </h1>
        <?php endif; ?>
